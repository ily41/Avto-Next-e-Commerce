  ...
  return (
    <footer className="w-full">
      ...
      {/* <div className="bg-[#007aff] py-8 lg:py-12">
        <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col lg:flex-row items-center justify-between gap-8">
      ...
      <div className="bg-[#f8f8f8] py-6 md:py-8">
        <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
