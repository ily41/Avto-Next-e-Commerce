  ...
  return (
    <footer className="w-full">
      ...
      {/* <div className="bg-[#007aff] py-8 lg:py-12">
        <div className="max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col lg:flex-row items-center justify-between gap-8">
      ...
      <div className="bg-white py-16 lg:py-20 border-b border-gray-100">
        <div className="max-w-[80%] mx-auto px-4 sm:px-6 lg:px-8 w-full">
