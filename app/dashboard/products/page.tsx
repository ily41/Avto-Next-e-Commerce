        ...
        <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6 px-6 md:px-10">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-4">
                    <h1 className="text-base md:text-xl lg:text-2xl font-bold">Məhsullar</h1>
                    {filteredData?.totalCount !== undefined && (
                        <div className="flex items-center gap-2 bg-emerald-500/5 border border-emerald-500/10 px-4 py-1.5 rounded-2xl shadow-sm">
                            <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500/70">Ümumi:</span>
                            <span className="text-sm font-black text-emerald-600">{filteredData.totalCount}</span>
                        </div>
                    )}
                </div>
